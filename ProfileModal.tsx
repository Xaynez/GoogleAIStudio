...
import type { UserProfile, Post, PostType, ExperienceEntry, EducationEntry, Comment, DegreeType, TranslatableContent, AuditLog } from '../types';
...
interface ProfileModalProps {
  ...
  addAuditLog: (event: string, details: Record<string, any>) => void;
}
...
export const ProfileModal: React.FC<ProfileModalProps> = ({ isOpen, onClose, userProfile, setUserProfile, initialTab, isCurrentUser, addAuditLog }) => {
                    ...
                    return (
                        <div className="space-y-6">
                            ...
                            <div>
                             ...
                             <div>
                                <label className="block text-sm font-medium text-slate-300 mb-2">Language & Region</label>
                                <LanguageSelector />
                            </div>
                            <div>
