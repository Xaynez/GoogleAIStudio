...
export const GovernanceModal: React.FC<GovernanceModalProps> = ({ onAccept }) => {
        ...
        <div className="fixed inset-0 bg-slate-950 z-[100] flex flex-col items-center justify-center p-4 animate-fade-in" aria-modal="true" role="dialog">
            <div className="w-full max-w-4xl h-full flex flex-col">
                <div className="text-center pt-8 pb-4 flex-shrink-0">
                    ...
                    <h1 className="text-3xl font-bold text-text-primary font-display heading-gradient">Governance & Compliance Framework</h1>
                    <p className="text-text-secondary mt-1">Please review and accept our framework to continue.</p>
                </div>
                ...
                <div className="py-6 text-center flex-shrink-0">
                    ...
                    >
                        I Have Read and Accept the Governance & Compliance Framework
                    </button>
                </div>
            </div>
        </div>
